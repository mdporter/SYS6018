...
loglike2 = map_dbl(lam.seq, ~sum(dpois(x, lambda=., log=TRUE)))
...
#---------------------------------------------------------------------------#
# Negative Binomial Model: ER counts Data
#---------------------------------------------------------------------------#
