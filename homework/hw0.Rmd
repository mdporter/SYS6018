...
date: "Due: Mon Jan 31 | 12:30pm (ungraded)"
...
- Help <https://rladiessydney.org/courses/ryouwithme/01-basicbasics-1/> and <https://moderndive.netlify.app/1-getting-started.html> and <https://education.rstudio.com/learn/beginner/>
...
A new machine learning model, developed by UVA researchers, uses biopsy
images to predict if a child has enteropathy or celiac disease. [In a
study of 102
patients](https://jamanetwork.com/journals/jamanetworkopen/fullarticle/2735765),
the model was able to correctly classify 95 of them.

Find the 90% [confidence
interval](https://en.wikipedia.org/wiki/Confidence_interval) for the
probability a patient is correctly classified?
...
## d. Hypothesis Testing {.tabset .tabset-pills}

Use the `movies_sample` (IMDb) data from the `moderndive` R package to
performance a hypothesis test that *Action* movies are ranked lower (on
average) than *Romance* movies.
